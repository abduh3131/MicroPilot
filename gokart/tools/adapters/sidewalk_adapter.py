"""segformer adapter that labels every pixel, finds the sidewalk, and steers to stay centered on it"""
...
SEG_ENGINE_PATH = "/home/jetson/openpilotV3_gokart/selfdrive/modeld/models/sidewalk_segmentation.engine"
SEG_ONNX_PATH = "/home/jetson/openpilotV3_gokart/selfdrive/modeld/models/sidewalk_segmentation.onnx"
...
# tensorrt gpu inference for the segmentation model
...
# onnx cpu fallback when tensorrt is not available
...
# runs segformer, finds the sidewalk, and steers to stay centered on it
class SidewalkAdapter(BaseModelAdapter):
    ...
    def _preprocess_frame(self, bgr_img):
        ...
        # imagenet normalization matches model training
