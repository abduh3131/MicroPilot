...
# main loop that writes a constant throttle while engaged
def run(speed, rate):
  ...
  while True:
    ...
    if autopilot_on and engaged:
      ...
      if lidar_stop:
        ...
        # cruise straight and let the lidar nudge add in downstream
...
def main():
  parser = argparse.ArgumentParser(description="Autopilot, self driving mode")
