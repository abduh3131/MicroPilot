...
# filters one scan down to the points inside the front cone
...
# finds the widest open gap to steer through
...
# decides stop or nudge based on the current scan and recent history
...
# reads raw lidar bytes and yields full scans
...
# main lidar loop using real hardware
...
# fake lidar mode for testing without hardware
...
def main():
  ...
  parser = argparse.ArgumentParser(description="Lidar safety, obstacle avoidance for scooter")
