      ...
      for n in os.listdir("/sys/devices/virtual/thermal"):
        ...
        with open(os.path.join("/sys/devices/virtual/thermal", n, "type")) as f:
          if f.read().strip() == self.name:
            self.zone_number = int(n.replace("thermal_zone", ""))
            break
...
@dataclass
class ThermalConfig:
  cpu: Optional[List[ThermalZone]] = None
  gpu: Optional[List[ThermalZone]] = None
  dsp: Optional[ThermalZone] = None
  pmic: Optional[List[ThermalZone]] = None
  memory: Optional[ThermalZone] = None
  intake: Optional[ThermalZone] = None
  exhaust: Optional[ThermalZone] = None
  case: Optional[ThermalZone] = None
...
class LPABase(ABC):
  ...
  @abstractmethod
  def download_profile(self, qr: str, nickname: Optional[str] = None) -> None:
    pass
