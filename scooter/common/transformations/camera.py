...
# ESP32-S3 OV3660 160° wide-angle on scooter (640x480 VGA)
# HFOV ~130° → focal_length = (640/2) / tan(130/2 * pi/180) ≈ 149
_scooter_cam = CameraConfig(640, 480, 149.0)
_scooter_config = DeviceCameraConfig(_scooter_cam, _NoneCameraConfig(), _NoneCameraConfig())
...
DEVICE_CAMERAS = {
  ...
  # scooter with ESP32-CAM
  ("scooter", "unknown"): _scooter_config,
  ("scooter", "ov3660"): _scooter_config,
}
