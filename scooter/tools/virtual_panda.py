...
# builds a fake comma body CarParams tuned for low speed
...
# main loop that publishes fake panda, car state, and car output messages
def main():
  ...
  while True:
    ...
    # manager wipes the params on ignition so it rewrites them for 30 seconds
